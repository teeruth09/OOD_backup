...
# def show_position():
#     for z in range(len(que.position)):
#         x = que.position[z][0]
#         y = que.position[z][1]

#         if que.list_que[y-1][x] == '_' and (x,y-1) not in que.all_result:           #north
#             position = (x,y-1)
#             que.enqueue_position(position)
            
#         if que.list_que[y][x+1] == '_' and (x+1,y) not in que.all_result:           #east
#             position = (x+1,y)   
#             que.enqueue_position(position)
            
#         if que.list_que[y+1][x] == '_' and (x,y+1) not in que.all_result:           #south
#             position = (x,y+1)
#             que.enqueue_position(position)
            
#         if que.list_que[y][x-1] == '_' and (x-1,y) not in que.all_result:           #west
#             position = (x-1,y)
#             que.enqueue_position(position)

#         elif que.list_que[y-1][x] == 'O' or que.list_que[y+1][x] == 'O' or que.list_que[y][x-1] == 'O' or que.list_que[y][x+1] == 'O':
